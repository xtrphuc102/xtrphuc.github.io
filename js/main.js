...
function showHelp() {
	...
	$("#inst_main_body").html("<div id = 'instructions_head'>CÁCH CHƠI</div><p>Nhiệm vụ của bạn là ngăn cho các khối ra khỏi hình lục giác màu xám</p><p>" + (settings.platform != 'mobile' ? 'Ấn phím mũi tên trái và phải' : 'Chạm vào bên trái và phải của bạn hình') + " để di chuyển hình lục giác" + (settings.platform != 'mobile' ? ' Ấn phím mũi tên xuống để tăng tốc độ rơi của khối.': '') + " </p><p>Để loại bỏ các khối bạn cần ghép trên 3 khối cùng màu với nhau.</p><p>Sau mỗi lần ghi điểm bạn sẽ có cơ hội cộng dồn điểm bằng cách tiếp tục ghép trên 3 khối cùng lại với nhau trong một khoảng thời gian nhất định. Thời gian sẽ được hiển thị bởi  <span style='color:#f1c40f;'>các</span> <span style='color:#e74c3c'>viền</span> <span style='color:#3498db'>màu sắc</span> <span style='color:#2ecc71'>ở</span> ngoài hình lục giác</p> <hr> <p id = 'afterhr'></p> Game viết bởi: <a href='http://loganengstrom.com' target='_blank'>Logan Engstrom</a> & <a href='http://github.com/garrettdreyfus' target='_blank'>Garrett Finucane</a><br>Việt hóa bởi <a href = 'https://baohuynh.me'>baohuynhc</a>");
	if (gameState == 1) {
		pause();
	}
