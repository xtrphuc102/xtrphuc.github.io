...
function renderBeginningText() {
    ...
    if(/mobile|Mobile|iOS|Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)) {
        mob = true;
        input_text = 'Chạm vào trái hoặc phải màn hình'
        action_text = 'để xoay hình lục giác'
        score_text = 'Ghép ít nhất 3 khối để ghi điểm!'
        fontSize = 35
    } else {
        mob = false
        input_text = 'Dùng bàn phím mũi tên trái phải'
        action_text = 'để xoay hình lục giác'
        score_text = 'Ghép ít nhất 3 khối để ghi điểm!'
        fontSize = 27
    }
