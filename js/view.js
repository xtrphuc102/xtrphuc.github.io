...
function showText(text) {
	var messages = {
		'paused': "<div class='centeredHeader unselectable'>GAME ĐÃ TẠM DỪNG</div>",
		'pausedAndroid': "<div class='centeredHeader unselectable'>GAME ĐÃ TẠM DỪNG</div>",
		'pausediOS': "<div class='centeredHeader unselectable'>GAME ĐÃ TẠM DỪNG</div>",
		'pausedOther': "<div class='centeredHeader unselectable'>GAME ĐÃ TẠM DỪNG</div>",
		'start': "<div class='centeredHeader unselectable' style='line-height:80px;'>Ấn enter để bắt đầu!</div>"
	};
